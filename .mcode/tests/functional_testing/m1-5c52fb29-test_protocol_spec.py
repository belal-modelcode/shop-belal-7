...
Generated at: 2026-03-18T05:27:47.304811+00:00
...
TEST_CASES: list[dict[str, Any]] = resolve_env_placeholders(
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Reject user creation with an already registered email",
        "setup": {
            "endpoint": "/users",
            "method": "POST",
            "body": {
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "POST",
        "description": "Reject user creation when email field is missing",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/users/{user_id}",
        "method": "GET",
        "description": "Return 404 for a non-existent user ID",
        "setup": null,
        "request_data": {
            "path": {
                "user_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/users",
        "method": "GET",
        "description": "List all users and expect an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "POST",
        "description": "Reject category creation when name is missing",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/categories",
        "method": "GET",
        "description": "List all categories and expect an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    {
        "name": "create_product_with_category",
        "category": "HAPPY_PATH",
        "endpoint": "/products",
        "method": "POST",
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Reject product creation with a non-existent category ID",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "POST",
        "description": "Reject product creation when name is missing",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
    ...
    },
    {
        ...
        "endpoint": "/products/{product_id}",
        "method": "GET",
        "description": "Return 404 for a non-existent product ID",
        "setup": null,
        "request_data": {
            "path": {
                "product_id": 999999
    ...
    },
    {
        ...
        "endpoint": "/products",
        "method": "GET",
        "description": "List all products and expect an array response",
        "setup": null,
        "request_data": {
            "path": {},
            "query": {},
